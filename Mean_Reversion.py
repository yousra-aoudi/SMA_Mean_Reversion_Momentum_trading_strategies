...
class MRVectorBacktester(MomVectorBacktester):
    ...
    def run_strategy(self, SMA, threshold):
        ...
        data['strategy'] = data['position'].shift(1) * data['return'] # determine when a trade takes place
...
if __name__ == '__main__':
    mrbt = MRVectorBacktester('Close', '2015-1-2', '2022-05-31', 10000, 0.0)
    print(mrbt.run_strategy(SMA=25, threshold=5))
    mrbt = MRVectorBacktester('Close', '2015-1-2', '2022-05-31', 10000, 0.001)
    print(mrbt.run_strategy(SMA=25, threshold=5))
    mrbt = MRVectorBacktester('Close', '2015-1-2', '2022-05-31', 10000, 0.001)
