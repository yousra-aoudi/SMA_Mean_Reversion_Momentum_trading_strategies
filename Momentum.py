...
class MomVectorBacktester(object):
    ...
    ==========
    feature: str
       feature ('close price') to work with
    start: str
    ...
    """
    def __init__(self, feature, start, end, amount, tc):
    ...
    def run_strategy(self, momentum=1):
        ...
        # subtract transaction costs from return when trade takes place data['strategy'][trades] -= self.tc
    ...
    def plot_results(self):
        ...
        title = '%s %s | TC = %.4f' % ('GLD',self.feature, self.tc)
...
if __name__ == '__main__':
    mombt = MomVectorBacktester('Close', '2015-01-02', '2022-05-31',10000, 0.0)
    print(mombt.run_strategy())
    print(mombt.run_strategy(momentum=2))
    mombt = MomVectorBacktester('Close', '2015-01-02', '2022-05-31',10000, 0.001)
    print(mombt.run_strategy(momentum=2))
    mombt.plot_results()